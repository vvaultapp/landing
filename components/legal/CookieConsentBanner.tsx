...
export default function CookieConsentBanner() {
  ...
  return (
    ...
    >
      ...
      <div aria-hidden className="pointer-events-none absolute inset-x-0 top-full h-24 bg-[rgb(var(--cookie-bg))] md:hidden" />
    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-wrap items-center justify-end gap-2.5 md:gap-2">
        ...
        <button
          ...
          className="inline-flex h-10 items-center rounded-full bg-[rgb(var(--inv))] px-6 text-[13px] font-semibold text-black hover:bg-[rgb(var(--ov)_/_0.9)] md:h-9 md:bg-[rgb(var(--cookie-bg))] md:px-4 md:text-[12.5px] md:text-[rgb(var(--fg))] md:hover:bg-[rgb(var(--ov)_/_0.06)]"
        >
          Save preferences
        </button>
      </div>
