  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundColor: open ? "rgb(var(--bg) / 0.6)" : "transparent",
            ...
            return (
              <div key={item.label}>
                ...
                >
                  ...
                  <svg
                    viewBox="0 0 20 20"
                    className={`h-5 w-5 fill-none stroke-current stroke-[1.5] text-[rgb(var(--fg)_/_0.3)] transition-transform duration-200 ${
                    ...
                    {item.children!.map((child) => {
                      ...
                      return (
                        ...
                        >
                          {child.label}
                          {isExternal && (
                            <svg viewBox="0 0 12 12" className="h-2.5 w-2.5 fill-none stroke-current stroke-[1.5] text-[rgb(var(--fg)_/_0.2)]">
  ...
  return (
    ...
    >
      ...
      >
        ...
        <svg
          viewBox="0 0 12 12"
          className="h-3 w-3 fill-none stroke-[1.8] text-[rgb(var(--fg)_/_0.25)]"
          style={{
            stroke: "currentColor",
...
export function LandingNav({ locale, content, showPrimaryLinks = true }: LandingNavProps) {
  ...
  return (
    ...
    <header
      ...
      style={{
        /* Offset by `--app-banner-h` (the iOS app-banner height) so the nav sits
           below it; defaults to 0 → pinned at the very top everywhere else. */
        ...
        backgroundColor:
          mergedWithPinned || mobileMenuOpen
            ? "transparent"
            : `rgb(var(--bg) / ${0.55 * scrollProgress})`,
        backdropFilter:
          mergedWithPinned || mobileMenuOpen
            ? "none"
    ...
    >
      <div className="mx-auto flex h-[62px] w-full max-w-[min(92vw,1220px)] items-center px-5 sm:h-[62px] sm:px-8 lg:h-[68px] lg:px-10">
        <Link
          href={homeHref}
