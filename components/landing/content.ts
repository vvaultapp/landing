...
const landingContentEn = {
  ...
  singlePlan: {
    ...
    bullets: [
      ...
      "Sell beats with Stripe checkout",
  ...
  pricingComparison: {
    human: {
      ...
      notIncluded: [
        ...
        "Vois qui ouvre et écoute",
        "Envoi depuis ton propre Gmail",
        "Vends tes beats et encaisse",
        "Programme + relances auto",
      ],
      cost: "€0",
