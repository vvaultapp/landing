  ...
  return (
    <div className="landing-root min-h-screen bg-[rgb(var(--bg))] font-sans text-[rgb(var(--fg))]">
      ...
      <header className="border-b border-[rgb(var(--ov)_/_0.1)]">
        <div className="mx-auto flex h-[70px] w-full max-w-[min(92vw,1220px)] items-center px-5 sm:px-8 lg:px-10">
          <Link
            href="/fr"
      ...
      <main id="main-content" className="pb-12 pt-12 sm:pb-16 sm:pt-16">
        <section className="mx-auto w-full max-w-[min(92vw,1220px)] px-5 sm:px-8 lg:px-10">
