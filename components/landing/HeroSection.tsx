    ...
    <div className="hero-seq-item mt-12 flex justify-center" style={{ animationDelay: "380ms" }}>
      <div className="flex flex-col items-center gap-2 text-center sm:flex-row sm:gap-3">
        ...
        <p className="text-sm text-white/85 sm:text-base">
          ...
          <span className="hidden sm:inline">{locale === "fr" ? "artistes & beatmakers" : "artists & beatmakers"}</span>
      ...
      <section className="relative pb-8 pt-48 sm:pb-12 sm:pt-52 lg:pb-16 lg:pt-58">
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1320px] px-5 sm:px-8 lg:px-10">
          ...
          <div className="hero-seq-item mt-7 flex flex-col items-center gap-3" style={{ animationDelay: "520ms" }}>
            <a
              href="https://lgpvvtnbxqnmpjrnuyqi.supabase.co/auth/v1/authorize?provider=google&redirect_to=https%3A%2F%2Fvvault.app%2Fauth%2Fcallback%3Fsignup_flow%3D1&prompt=select_account"
              className="inline-flex items-center gap-2.5 rounded-2xl bg-white px-6 py-3 text-[15px] font-semibold text-[#0e0e0e] transition-all duration-200 hover:brightness-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/45 sm:px-7 sm:py-3 sm:text-base"
              style={{
                boxShadow: "inset 0 1.5px 0 0 rgba(255,255,255,0.95), inset 0 -1.5px 2px 0 rgba(0,0,0,0.08), 0 0 8px 0 rgba(255,255,255,0.12), 0 1px 3px 0 rgba(255,255,255,0.1)",
              }}
            >
