  ...
  return (
    <div className="relative" onMouseEnter={openMenu} onMouseLeave={closeMenu}>
      ...
      <div
        ...
        style={{
          /* Solid dark panel, no outline — the menu tabs read as one
             clean opaque surface instead of an outlined translucent box. */
          background: "#18181b",
    ...
    <div className="pointer-events-none fixed inset-x-0 bottom-8 z-[60] mx-auto hidden max-w-[clamp(1320px,92vw,2400px)] px-5 sm:px-8 lg:flex lg:justify-end lg:px-10">
      <div className="pointer-events-auto flex items-center gap-2.5">
        ...
        <a
          ...
          onClick={() => trackButtonClick({ buttonId: "hero.download_ios", surface: "landing.pinned", locale, href: "https://apps.apple.com/app/id6759256796" })}
