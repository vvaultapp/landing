  ...
  return (
    <div className="relative" onMouseEnter={openMenu} onMouseLeave={closeMenu}>
      ...
      <button
        ...
        className="inline-flex h-12 items-center gap-2 rounded-full bg-[rgb(var(--ov)_/_0.08)] px-5 text-[15px] font-medium text-[rgb(var(--fg)_/_0.8)] hover:bg-[rgb(var(--ov)_/_0.12)] hover:text-[rgb(var(--fg))]"
      >
...
export function PinnedQuickMenu() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-8 z-[60] mx-auto hidden max-w-[min(92vw,1300px)] px-5 sm:px-8 lg:flex lg:justify-end lg:px-10">
