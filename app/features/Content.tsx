...
function getFeatures(locale: "en" | "fr") {
  ...
  return [
    ...
    },
    {
      ...
      description: fr
        ? "Publication vidéo automatisée et identification de contenu pour les producteurs."
        : "Automated video posting and content identification for producers.",
      bullets: fr
        ? [
            "Génère et publie automatiquement des vidéos depuis tes packs",
            "WaveMatch : identifie qui utilise tes beats sur YouTube, Spotify et Apple Music",
            "Templates dynamiques avec BPM, tonalité et tokens sociaux",
            "Autoscan pour surveiller ton catalogue en continu",
          ]
        : [
            "Auto-generate and post videos from your packs",
            "WaveMatch: find who used your beats on YouTube, Spotify, and Apple Music",
            "Dynamic templates with BPM, key, and social tokens",
            "Autoscan to monitor your catalog continuously",
          ],
    },
    {
      title: fr ? "Sessions d'écriture" : "Writing Sessions",
      href: "/docs/writing-sessions",
      description: fr
        ? "Espaces collaboratifs en temps réel pour la création musicale."
        : "Real-time collaborative workspaces for music creation.",
      bullets: fr
        ? [
            "Upload de tracks, votes et tags en temps réel",
            "Gestion des splits et des crédits par track",
            "Timeline d'activité en direct",
            "Idéal pour les beat battles et les sessions de production",
          ]
        : [
            "Real-time track uploads, voting, and tagging",
            "Per-track split and credit management",
            "Live activity timeline",
            "Perfect for beat battles and production sessions",
          ],
    },
    {
      title: fr ? "Équipes" : "Teams",
      href: "/docs/teams",
      description: fr
        ? "Comptes collaboratifs pour travailler sous une identité partagée."
        : "Collaborative team accounts with shared workspaces.",
      bullets: fr
        ? [
            "Crée des équipes avec nom, avatar et bannière",
            "Liens d'invitation tokenisés",
            "Profil d'équipe public",
            "Espace de travail partagé pour packs et campagnes",
          ]
        : [
            "Create teams with name, avatar, and banner",
    ...
    {
      title: fr ? "Lecteur audio" : "Audio Player",
      href: "/docs/audio-player",
      description: fr
        ? "Un lecteur persistant avec forme d'onde, file d'attente et qualité sélectionnable."
        : "A persistent player with waveform, queue, and selectable quality.",
      bullets: fr
        ? [
            "Lecture continue sur toutes les pages",
            "Forme d'onde navigable et contrôle du volume",
            "Modes de lecture : Off, Repeat, Shuffle",
            "Qualité sélectionnable : Ultra, Compressé, Full",
          ]
        : [
            "Continuous playback across all pages",
            "Seekable waveform and volume control",
            "Playback modes: Off, Repeat, Shuffle",
            "Selectable quality: Ultra, Compressed, Full",
          ],
    },
    {
      title: fr ? "Lecteur embarqué" : "Embed Player",
      href: "/docs/embed-player",
      description: fr
        ? "Intègre des lecteurs audio sur ton site web ou portfolio avec suivi complet."
        : "Embed audio players on your website or portfolio with full tracking.",
      bullets: fr
        ? [
            "Embed de track unique ou de pack complet",
            "Code iframe à copier-coller",
            "Suivi des écoutes dans les analytics",
            "Tailles personnalisables et prévisualisation",
          ]
        : [
            "Single track or full pack embeds",
            "Copy-paste iframe embed code",
            "Play tracking in analytics",
            "Customizable sizes and preview",
          ],
    },
    {
      title: fr ? "Application bureau" : "Desktop App",
      href: "/docs/desktop-app",
      description: fr
        ? "Application native avec synchronisation de fichiers et accès hors ligne."
        : "Native desktop app with local file sync and offline access.",
      bullets: fr
        ? [
            "Disponible sur macOS et Windows",
            "Synchronisation automatique des dossiers locaux",
            "Notifications natives de l'OS",
            "Cache local pour une lecture plus rapide",
          ]
        : [
            "Available on macOS and Windows",
            "Auto-sync local folders to cloud",
            "Native OS notifications",
            "Local cache for faster playback",
          ],
    },
    {
      title: fr ? "Liens de partage" : "Share Links",
      href: "/docs/share-links",
      description: fr
        ? "Génère des liens de partage trackés pour tous tes contenus."
        : "Generate tracked share links for all your content.",
      bullets: fr
        ? [
            "Pages de partage pour packs, tracks, campagnes et dossiers",
            "Téléchargements par track ou en ZIP complet",
            "Protection par mot de passe optionnelle",
            "Liens courts pour les réseaux sociaux",
          ]
        : [
            "Share pages for packs, tracks, campaigns, and folders",
            "Per-track or full-pack ZIP downloads",
            "Optional password protection",
            "Short links for social media",
          ],
    },
    {
      title: fr ? "Liens d'accès" : "Access Links",
      href: "/docs/access-links",
      description: fr
        ? "Partage sécurisé avec permissions granulaires et demandes d'accès."
        : "Secure sharing with granular permissions and access requests.",
      bullets: fr
        ? [
            "Trois niveaux : Lecteur, Commentateur, Éditeur",
            "Modes d'audience : public ou sur invitation",
            "Demandes d'accès avec approbation en un clic",
            "Révoque ou régénère les liens à tout moment",
          ]
        : [
            "Three tiers: Viewer, Commenter, Editor",
            "Audience modes: anyone or invites only",
            "Access requests with one-click approval",
            "Revoke or regenerate links anytime",
          ],
    },
    {
      title: "Certificate",
