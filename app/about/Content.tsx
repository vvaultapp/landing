    ...
    <div className="landing-root min-h-screen bg-[rgb(var(--bg))] font-sans text-[rgb(var(--fg))]">
      ...
      <main className="relative z-10 mx-auto max-w-[720px] px-5 pb-32 pt-40 sm:px-8 sm:pt-48">
        ...
        <div className="mt-20 space-y-16">
          {/* Mission */}
          <Reveal>
            <h2 className="text-xl font-medium text-[rgb(var(--fg))] sm:text-2xl">{fr ? "Notre mission" : "Our Mission"}</h2>
            <p className="mt-3 text-[14px] leading-relaxed text-[rgb(var(--fg)_/_0.4)] sm:text-[15px]">
              {fr
          ...
          {/* What We Do */}
          <Reveal>
            <h2 className="text-xl font-medium text-[rgb(var(--fg))] sm:text-2xl">{fr ? "Ce qu'on fait" : "What We Do"}</h2>
            <p className="mt-3 text-[14px] leading-relaxed text-[rgb(var(--fg)_/_0.4)] sm:text-[15px]">
              {fr
          ...
          {/* Team */}
          <Reveal>
            <h2 className="text-xl font-medium text-[rgb(var(--fg))] sm:text-2xl">{fr ? "Notre équipe" : "Our Team"}</h2>
            <p className="mt-3 text-[14px] leading-relaxed text-[rgb(var(--fg)_/_0.4)] sm:text-[15px]">
              {fr
          ...
          {/* Values */}
          <Reveal>
            <h2 className="text-xl font-medium text-[rgb(var(--fg))] sm:text-2xl">{fr ? "Nos valeurs" : "Our Values"}</h2>
            <div className="mt-4 space-y-4">
              <div>
                <h3 className="text-[14px] font-medium text-[rgb(var(--fg)_/_0.7)] sm:text-[15px]">
                  {fr ? "Transparence" : "Transparency"}
                </h3>
                <p className="mt-1 text-[14px] leading-relaxed text-[rgb(var(--fg)_/_0.4)] sm:text-[15px]">
                  {fr
