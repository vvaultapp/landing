...
export default function DownloadPage() {
  ...
  const primaryClass =
    "inline-flex items-center gap-2.5 rounded-2xl px-6 py-3 text-[15px] font-semibold text-[#0e0e0e] transition-all duration-200 hover:opacity-90";
  const secondaryClass =
    "inline-flex items-center gap-2.5 rounded-2xl px-6 py-3 text-[15px] font-medium text-white/50 transition-colors duration-200 hover:text-white/80";
  ...
  const macButton = (
    <a
      ...
      style={macPrimary ? buttonStyle : undefined}
    >
      {downloadIcon}
  ...
  const winButton = (
    <a
      ...
      style={winPrimary ? buttonStyle : undefined}
    >
      {downloadIcon}
