  ...
  return (
    <div className="landing-root min-h-screen bg-[rgb(var(--bg))] font-sans text-[rgb(var(--fg))]">
      ...
      <main className="relative pb-32">
        <div className="mx-auto w-full max-w-[min(92vw,1200px)] px-4 pt-[140px] sm:px-8 sm:pt-48 lg:px-10">
          <div className="flex flex-col items-center gap-12 lg:flex-row lg:items-center lg:justify-center lg:gap-[clamp(3.5rem,7vw,8.5rem)]">
            ...
            <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
              ...
              <a
                ...
                className="mt-9 inline-flex items-center justify-center gap-2.5 rounded-full bg-[rgb(var(--inv))] px-6 py-4 text-[16px] font-semibold text-[rgb(var(--inv-fg))] hover:opacity-90"
              >
