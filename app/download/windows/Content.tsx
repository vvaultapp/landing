        ...
        <div className="mx-auto flex w-full max-w-[1320px] flex-col items-center px-5 sm:px-8 lg:px-10">
          ...
          <div className="mt-10 flex flex-col items-center gap-3">
            <button
              ...
              disabled
              aria-disabled="true"
              className="inline-flex cursor-not-allowed items-center gap-2.5 whitespace-nowrap rounded-2xl border border-[rgb(var(--ov)_/_0.08)] bg-[rgb(var(--ov)_/_0.03)] px-6 py-3 text-[15px] font-medium text-[rgb(var(--fg)_/_0.35)]"
            >
              <svg
                viewBox="0 0 20 20"
          ...
          <div className="mt-20 w-full max-w-sm">
            <div className="rounded-2xl border border-[rgb(var(--ov)_/_0.06)] bg-[rgb(var(--ov)_/_0.02)] p-5">
              <div className="flex items-center gap-2">
                <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current text-[rgb(var(--fg)_/_0.4)]">
                  <path d="M3 12V6.5l8-1.1V12H3zm9-6.8V12h9V3L12 5.2zM12 13v6.7L21 22v-9H12zm-1 0H3v5.5l8 1.1V13z" />
                </svg>
                <h3 className="text-[14px] font-semibold text-[rgb(var(--fg)_/_0.7)]">Windows</h3>
              </div>
              <p className="mt-2 text-[13px] text-[rgb(var(--fg)_/_0.35)]">
                Windows 10 {fr ? "ou plus récent" : "or later"}
              </p>
              <p className="mt-1 text-[13px] text-[rgb(var(--fg)_/_0.35)]">
                64-bit (x64)
              </p>
            </div>
          </div>
          ...
          <section className="mt-28 w-full max-w-3xl">
            <h2 className="text-center font-display text-[28px] font-semibold text-[rgb(var(--fg))] sm:text-[32px]">
              {fr ? "Pourquoi l'app Windows ?" : "Why the Windows app?"}
            </h2>
            <p className="mx-auto mt-3 max-w-xl text-center text-[15px] leading-relaxed text-[rgb(var(--fg)_/_0.45)]">
              {fr
            ...
            <div className="mt-12 grid gap-5 sm:grid-cols-2">
              <div className="rounded-2xl border border-[rgb(var(--ov)_/_0.06)] bg-[rgb(var(--ov)_/_0.02)] p-6">
                <h3 className="text-[15px] font-semibold text-[rgb(var(--fg)_/_0.85)]">
                  {fr ? "Drag & drop natif" : "Native drag & drop"}
                </h3>
                <p className="mt-2 text-[13.5px] leading-relaxed text-[rgb(var(--fg)_/_0.45)]">
                  {fr
          ...
          <section className="mt-24 w-full max-w-3xl">
            <h2 className="text-center font-display text-[26px] font-semibold text-[rgb(var(--fg))] sm:text-[30px]">
            ...
            <ul className="mx-auto mt-8 max-w-xl space-y-3 text-[14px] leading-relaxed text-[rgb(var(--fg)_/_0.55)]">
              <li className="flex gap-3">
                <span className="mt-1 inline-block h-1.5 w-1.5 shrink-0 rounded-full bg-[rgb(var(--ov)_/_0.4)]" />
                <span>
                  {fr
          ...
          <section className="mt-24 w-full max-w-3xl">
            ...
            <ol className="mx-auto mt-8 max-w-xl space-y-4 text-[14px] leading-relaxed text-[rgb(var(--fg)_/_0.55)]">
              <li>
                <span className="font-medium text-[rgb(var(--fg)_/_0.75)]">
                  {fr ? "1. Télécharge l'installeur .exe" : "1. Download the .exe installer"}
                </span>
                <p className="mt-1 text-[rgb(var(--fg)_/_0.45)]">
                  {fr
